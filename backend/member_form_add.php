...
<form  name="register" action="member_form_add_db.php" method="POST" class="form-horizontal">
      <h1>Add Member Form</h1>
       <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-10" align="left">
            <input  name="m_email" type="email" class="form-control" id="m_email"   placeholder=" email@mail.com"/>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-10" align="left">
            <input  name="m_tel" type="text" class="form-control" id="m_tel"  placeholder="เบอร์โทร 10 หลัก" maxlength="10" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-10" align="left">
